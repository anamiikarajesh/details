...
class LoginPage extends React.Component {
    ...
    render() {
        return (
            <div className="container" style={{backgroundImage:'url(https://media.licdn.com/dms/image/C511BAQGvg6B3iz6x4w/company-background_10000/0/1584477887564/jyothi_engineering_college_cheruthuruthy_cover?e=2147483647&v=beta&t=y5V5FZ-2JcJuF7Zt7rh2s0P4iyK-hvUD7dMkRLBo7pI)',height:'100vh'}}>
