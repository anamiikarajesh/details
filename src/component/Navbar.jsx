        ...
        return (
            <div className="container" style={{backgroundColor:'#E6E6FA',height:'100vh',backgroundSize:'cover'}}>
                ...
                <div className="button-container" style={{ textAlign: 'center' , marginTop: '20px' }}>
                    <button className="student-login"  style={{ backgroundColor: '#FFB6C1', marginRight: '10px', padding: '10px 20px', border: 'none', borderRadius: '5px', cursor: 'pointer',color:'white' }}>Home</button>
