    ...
    render() {
        return (
            <div className="container" style={{backgroundImage:'url(main.jpg)',height:'100vh',backgroundSize:'cover'}}>
                <h1 style={{ textAlign: 'center', color: '#CCCCCC', fontWeight: 'bold' ,paddingTop:'20px'}}>Beyond the Crest</h1>
                <div className="button-container" style={{ textAlign: 'center' , marginTop: '20px' }}>
                    <button className="student-login"  style={{ backgroundColor: '#9FA8DA', marginRight: '10px', padding: '10px 20px', border: 'none', borderRadius: '5px', cursor: 'pointer' }}>Home</button>
